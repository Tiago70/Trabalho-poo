...
public class view extends JFrame {
	...
	JLabel msgVincularAouP = new JLabel("<html>Coloque a Matricula para vincular um aluno <br>Nome para vincular um professor</html>");
	...
	public view() {
		...
		painelExibirInfo.setBounds(41, 165, 150, 131);
	...
	private void eventosAluno() {
		...
		// Reseta as ações de alguns botões compartilhados para evitar bugs (essa função está no final)
		resetarAcoes(btnCadastrar, btnConfirmarCadastro, btnConsultar, btnConfirmarConsulta, btnEditar, btnSalvarEdicao, btnExcluir, btnSairDoControle);
	...
	private void eventosCurso() {
		...
		btnVincularAluno.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (indexCurso >= 0) {
					int indexEstudante = controlador.consultarEstudante(entradaVincularAouP.getText(), entradaVincularAouP.getText());
					if (indexEstudante >= 0) {
						controlador.vincularNoCurso(controlador.Estudantes.get(indexEstudante), entradaVincularCurso.getText());
						grupoPaineis.show(paineis, "Tela de Controle");
		...
		btnVincularProfessor.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (indexCurso >= 0) {
					...
					if (indexProfessor >= 0) {
						controlador.vincularNoCurso(controlador.Professores.get(indexProfessor), entradaVincularCurso.getText());
						grupoPaineis.show(paineis, "Tela de Controle");
						entradaVincularCurso.setText("");
						msgVincularAouP.setText("");
					}
				}
			}
		});
	...
	private void gerarRelatorio() {
		...
		btnGerarRelAluno.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (controlador.Estudantes.size() == 0) return;
		...
		btnGerarRelProfessor.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (controlador.Professores.size() == 0) return;
